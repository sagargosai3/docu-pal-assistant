...
import ChatInterface from '@/components/ChatInterface'; // 1. Import

export default function Machines() {
  const pageCategory = "machine-details"; // 2. Define category
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-8 max-w-4xl space-y-8">
        <div>
          <h1 className="text-3xl font-bold mb-4">Machines</h1>
